...
| <code><a href="#fantasy-hockey-notifier-cdk.FantasyHockeyNotifier.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="fantasy-hockey-notifier-cdk.FantasyHockeyNotifier.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="fantasy-hockey-notifier-cdk.FantasyHockeyNotifier.with.parameter.mixins"></a>
